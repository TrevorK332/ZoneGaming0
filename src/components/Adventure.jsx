                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <h3>CATEGORIES</h3>
                            <span className="breadcrumb"><Link to="/">Home</Link> {">"} <Link to="/category">Categories</Link> {">"} Adventure</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="section trending">
                <div className="container">
                    <ul className="trending-filter">
                        ...
                        <li>
                            <Link className="is_active" to="/category_adventure" data-filter=".adv">Adventure</Link>
                        </li>
                        <li>
